...
if [ $BACKGROUND_WHITE -eq 1 ]; then BACKGROUND='-c CANVAS#FFFFFF';
else BACKGROUND='-c CANVAS#000000'; fi
...
if [ "$1" == "processes" ]	|| ( [ "$1" == "" ] && [ "$RUN_PRO" == "1" ] ); then CREATE_GRAPHS "processes"		"System Processes"; fi
